...
export const Table = ({ form, deleteData, sortLH, sortHL, filterDepartment }) => {
    return (
        <div className="tableBox">
            <p className="display-6 text-center">Users Data</p>
            <div className="input-group mb-3">
            <button onClick={sortLH} className="btn btn-outline-secondary">Salary Increment</button>
            <button onClick={sortHL} className="btn btn-outline-secondary">Salary Decrement</button>
